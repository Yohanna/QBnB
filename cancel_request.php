    ...
    <body>
        <div class="container">
            <div class="col-md-4 col-md-offset-4">
                <div class="row">
                    <h3>Cancel Property?</h3>
                </div>
                <form action="cancel_request.php?booking_id=<?= $booking_id?>" method="post">
                    <p class="alert alert-danger">Are you sure you want to cancel this request?</p>
                    <div class="col-md-offset-4">
                        <button type="submit" name="cancelBtn" class="btn btn-danger btn-lg">Yes</button>
